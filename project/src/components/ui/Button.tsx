...
export const Button = ({
  ...
  const variantStyles = {
    ...
    outline: 'bg-transparent border border-gray-200 text-gray-700 hover:bg-gray-50 focus:ring-primary-200',
    ghost: 'bg-transparent text-gray-700 hover:bg-gray-100 focus:ring-primary-200',
